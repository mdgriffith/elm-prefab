...
var $author$project$Theme$Theme = F6(
	function (colors, palettes, spacing, typography, borders, shadows) {
		return {borders: borders, colors: colors, palettes: palettes, shadows: shadows, spacing: spacing, typography: typography};
	});
var $author$project$Theme$BorderVariant = F2(
	function (rounded, width) {
		return {rounded: rounded, width: width};
	});
...
var $author$project$Theme$Decoder$decodeBorderVariant = A3(
	$elm$json$Json$Decode$map2,
	$author$project$Theme$BorderVariant,
	A2(
		$elm$json$Json$Decode$map,
		$elm$core$Maybe$withDefault(0),
		$elm$json$Json$Decode$maybe(
			A2($elm$json$Json$Decode$field, 'rounded', $elm$json$Json$Decode$int))),
	A2(
		$elm$json$Json$Decode$map,
		$elm$core$Maybe$withDefault(1),
		$elm$json$Json$Decode$maybe(
			A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int))));
var $author$project$Theme$ColorPalette = F3(
	function (foreground, background, border) {
...
var $author$project$Theme$Color = F3(
	function (a, b, c) {
...
var $author$project$Theme$Decoder$hex8 = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
...
var $author$project$Theme$Decoder$parseHex16 = A2(
	...
	A2(
		...
		$author$project$Theme$Decoder$hex8),
	$author$project$Theme$Decoder$hex8);
var $author$project$Theme$Decoder$parseHex = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
			...
			A2(
				$elm$parser$Parser$ignorer,
				$elm$parser$Parser$succeed($author$project$Theme$Color),
				$elm$parser$Parser$symbol('#')),
			$author$project$Theme$Decoder$parseHex16),
		$author$project$Theme$Decoder$parseHex16),
	$author$project$Theme$Decoder$parseHex16);
...
var $author$project$Theme$Decoder$parseRgb = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		A2(
	...
	A2(
		...
		A2($elm$parser$Parser$ignorer, $elm$parser$Parser$int, $elm$parser$Parser$spaces),
		$elm$parser$Parser$symbol(')')));
var $author$project$Theme$Decoder$parseColor = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[$author$project$Theme$Decoder$parseRgb, $author$project$Theme$Decoder$parseHex]));
...
var $author$project$Theme$Decoder$decodeColor = A2(
	...
	function (string) {
		var _v0 = A2($elm$parser$Parser$run, $author$project$Theme$Decoder$parseColor, string);
		if (_v0.$ === 'Ok') {
			var color = _v0.a;
...
var $author$project$Theme$Decoder$decodeColorPalette = A2(
	$elm$json$Json$Decode$map,
	$elm$core$List$map(
		function (_v0) {
			var key = _v0.a;
	...
	$elm$json$Json$Decode$keyValuePairs(
		A4(
			...
			$author$project$Theme$ColorPalette,
			A2($elm$json$Json$Decode$field, 'foreground', $author$project$Theme$Decoder$decodeColor),
			A2($elm$json$Json$Decode$field, 'background', $author$project$Theme$Decoder$decodeColor),
			A2($elm$json$Json$Decode$field, 'border', $author$project$Theme$Decoder$decodeColor))));
...
var $author$project$Theme$Decoder$decodePalette = function (decodeThing) {
	return $elm$json$Json$Decode$oneOf(
		_List_fromArray(
			[
				A2($elm$json$Json$Decode$map, $author$project$Theme$Single, decodeThing),
				A2(
				$elm$json$Json$Decode$map,
				$author$project$Theme$Palette,
				$author$project$Theme$Decoder$decodeNamed(decodeThing))
			]));
};
	...
	if (palette.$ === 'Single') {
		...
		return A2(
			...
			function (_v2) {
				...
				return {
					item: item,
					name: $author$project$Theme$Name(
						_Utils_ap(
							key,
...
var $author$project$Theme$Decoder$decodeColorSwatch = A2(
	$elm$json$Json$Decode$map,
	$elm$core$List$concatMap($author$project$Theme$Decoder$flattenPalette),
	$elm$json$Json$Decode$keyValuePairs(
		$author$project$Theme$Decoder$decodePalette($author$project$Theme$Decoder$decodeColor)));
var $author$project$Theme$Typeface = F6(
	function (face, fallback, weight, size, lineSpacing, colors) {
		return {colors: colors, face: face, fallback: fallback, lineSpacing: lineSpacing, size: size, weight: weight};
	});
var $elm$json$Json$Decode$list = _Json_decodeList;
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Theme$Decoder$decodeTypeface = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Theme$Typeface,
	A2($elm$json$Json$Decode$field, 'face', $elm$json$Json$Decode$string),
	A2(
	...
	A2(
		$elm$json$Json$Decode$map,
		$elm$core$Maybe$withDefault(400),
		$elm$json$Json$Decode$maybe(
	...
	A2(
		...
		$elm$core$Maybe$withDefault(1),
		$elm$json$Json$Decode$maybe(
			A2($elm$json$Json$Decode$field, 'lineSpacing', $elm$json$Json$Decode$int))),
	A2(
		$elm$json$Json$Decode$field,
		'color',
		$author$project$Theme$Decoder$decodePalette($author$project$Theme$Decoder$decodeColor)));
var $author$project$Theme$Decoder$decode = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Theme$Theme,
	A2($elm$json$Json$Decode$field, 'colors', $author$project$Theme$Decoder$decodeColorSwatch),
	A2($elm$json$Json$Decode$field, 'palettes', $author$project$Theme$Decoder$decodeColorPalette),
	A2(
		$elm$json$Json$Decode$field,
		'spacing',
	...
	A2(
		$elm$json$Json$Decode$field,
		'typography',
		$author$project$Theme$Decoder$decodeNamed($author$project$Theme$Decoder$decodeTypeface)),
	A2(
		$elm$json$Json$Decode$field,
		'borders',
		$author$project$Theme$Decoder$decodeNamed($author$project$Theme$Decoder$decodeBorderVariant)),
	A2(
		$elm$json$Json$Decode$field,
		'shadows',
...
var $author$project$Theme$Generate$Ui$attr = function (a) {
	return A2(
		...
		$author$project$Gen$Ui$annotation_.attribute(
			$mdgriffith$elm_codegen$Elm$Annotation$var('msg')),
		a);
};
			...
			[
				...
				_List_fromArray(
					[
						...
						$elm$core$Tuple$pair,
						'name',
						$mdgriffith$elm_codegen$Elm$string(fontArg.name)),
						A2(
						$elm$core$Tuple$pair,
						'fallback',
						$mdgriffith$elm_codegen$Elm$list(fontArg.fallback)),
						A2(
						$elm$core$Tuple$pair,
						'variants',
						$mdgriffith$elm_codegen$Elm$list(fontArg.variants)),
						A2($elm$core$Tuple$pair, 'weight', fontArg.weight),
						A2(
						$elm$core$Tuple$pair,
						'size',
						$mdgriffith$elm_codegen$Elm$int(fontArg.size))
					]))
			]));
};
...
var $author$project$Theme$Generate$Ui$toColor = function (_v0) {
	...
	var g = _v0.b;
	var b = _v0.c;
	return A3($author$project$Gen$Ui$rgb, r, g, b);
};
		...
		A2(
			...
			function (_v0) {
				...
				return $mdgriffith$elm_codegen$Elm$expose(
					A2($mdgriffith$elm_codegen$Elm$declaration, name, val));
			},
			A2($author$project$Theme$Generate$Ui$toFields, $author$project$Theme$Generate$Ui$toColor, theme.colors)));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						A2($elm$core$Tuple$pair, 'background', paletteArg.background),
						A2($elm$core$Tuple$pair, 'border', paletteArg.border),
						A2($elm$core$Tuple$pair, 'font', paletteArg.font)
					]))
			]));
};
			...
			function (_v0) {
				...
				return $mdgriffith$elm_codegen$Elm$expose(
					A2(
						...
						$author$project$Theme$nameToString(name),
						$author$project$Gen$Ui$palette(
							{
								background: $author$project$Theme$Generate$Ui$toColor(item.background),
								border: $author$project$Theme$Generate$Ui$toColor(item.border),
								font: $author$project$Theme$Generate$Ui$toColor(item.foreground)
							})));
			},
			theme.palettes));
};
			...
			$elm$core$List$concat(
				_List_fromArray(
					[
									...
									_Utils_Tuple2(
										...
										$elm$core$Maybe$Just(
											$mdgriffith$elm_codegen$Elm$Annotation$list(
												$author$project$Gen$Ui$annotation_.attribute(
													$mdgriffith$elm_codegen$Elm$Annotation$var('msg'))))),
									_Utils_Tuple2('body', $elm$core$Maybe$Nothing),
									F2(
										function (attrs, body) {
											return A2(
												$author$project$Gen$Ui$call_.layout,
												A2(
													$mdgriffith$elm_codegen$Elm$Op$cons,
													A2(
														$mdgriffith$elm_codegen$Elm$get,
														'default',
														$mdgriffith$elm_codegen$Elm$val('font')),
													attrs),
												body);
										}))))
						]),
						...
						$elm$core$List$filterMap,
						function (typeface) {
							var name = $author$project$Theme$nameToString(typeface.name);
							return A2(
								$elm$core$List$member,
								name,
								_List_fromArray(
									['h1', 'h2', 'h3', 'h4', 'h5', 'h6'])) ? $elm$core$Maybe$Just(
								$mdgriffith$elm_codegen$Elm$expose(
									A2(
										$mdgriffith$elm_codegen$Elm$declaration,
										name,
													...
													return A2(
														...
														A2(
															...
															A2(
																...
																$mdgriffith$elm_codegen$Elm$val('font')),
															attrs),
														$author$project$Gen$Ui$call_.text(label));
												}))))) : $elm$core$Maybe$Nothing;
						},
						theme.typography),
						_List_fromArray(
									...
									A2(
										...
										function (typeface) {
											return $author$project$Gen$Ui$Font$font(
												{
													fallback: _List_fromArray(
														[$author$project$Gen$Ui$Font$serif]),
													name: typeface.face,
													size: typeface.size,
													variants: _List_Nil,
													weight: (typeface.weight === 400) ? $author$project$Gen$Ui$Font$regular : $author$project$Gen$Ui$Font$bold
												});
										},
										theme.typography)))),
							$mdgriffith$elm_codegen$Elm$expose(
							A2(
								...
								$mdgriffith$elm_codegen$Elm$record(
									A2(
										$author$project$Theme$Generate$Ui$toFields,
										function (border) {
											return $author$project$Gen$Ui$border(border.width);
										},
										theme.borders)))),
							$mdgriffith$elm_codegen$Elm$expose(
							A2(
								...
								$mdgriffith$elm_codegen$Elm$record(
									A2(
										$author$project$Theme$Generate$Ui$toFields,
										A2($elm$core$Basics$composeL, $author$project$Theme$Generate$Ui$attr, $author$project$Gen$Ui$spacing),
										theme.spacing)))),
							$mdgriffith$elm_codegen$Elm$expose(
							A2(
								$mdgriffith$elm_codegen$Elm$declaration,
								...
								$mdgriffith$elm_codegen$Elm$record(
									A2(
										...
										function (spacing) {
											return A3(
												$mdgriffith$elm_codegen$Elm$fn2,
												_Utils_Tuple2('attrs', $elm$core$Maybe$Nothing),
												...
												F2(
													function (attrs, children) {
														return A2(
															...
															A2(
																$mdgriffith$elm_codegen$Elm$Op$cons,
																$author$project$Gen$Ui$spacing(spacing),
																attrs),
															children);
													}));
										},
							...
							A2(
								...
								$mdgriffith$elm_codegen$Elm$record(
									_Utils_ap(
										A2(
											$author$project$Theme$Generate$Ui$toFields,
											A2($elm$core$Basics$composeL, $author$project$Theme$Generate$Ui$attr, $author$project$Gen$Ui$padding),
											theme.spacing),
										_List_fromArray(
											[
												_Utils_Tuple2(
														...
														function (spacingX) {
															return $mdgriffith$elm_codegen$Elm$record(
																A2(
																	$author$project$Theme$Generate$Ui$toFields,
																	function (spacingY) {
																		return $author$project$Theme$Generate$Ui$attr(
																			A2($author$project$Gen$Ui$paddingXY, spacingX, spacingY));
																	},
																	theme.spacing));
														},
														theme.spacing))),
												...
												$mdgriffith$elm_codegen$Elm$record(
													A2(
														$author$project$Theme$Generate$Ui$toFields,
														A2($elm$core$Basics$composeL, $author$project$Theme$Generate$Ui$attr, $author$project$Gen$Ui$paddingTop),
														theme.spacing))),
												_Utils_Tuple2(
												'right',
												$mdgriffith$elm_codegen$Elm$record(
													A2(
														$author$project$Theme$Generate$Ui$toFields,
														A2($elm$core$Basics$composeL, $author$project$Theme$Generate$Ui$attr, $author$project$Gen$Ui$paddingRight),
														theme.spacing))),
												_Utils_Tuple2(
												'bottom',
												$mdgriffith$elm_codegen$Elm$record(
													A2(
														$author$project$Theme$Generate$Ui$toFields,
														A2($elm$core$Basics$composeL, $author$project$Theme$Generate$Ui$attr, $author$project$Gen$Ui$paddingBottom),
														theme.spacing))),
												_Utils_Tuple2(
												'left',
												$mdgriffith$elm_codegen$Elm$record(
													A2(
														$author$project$Theme$Generate$Ui$toFields,
														A2($elm$core$Basics$composeL, $author$project$Theme$Generate$Ui$attr, $author$project$Gen$Ui$paddingLeft),
														theme.spacing)))
											])))))
						])
					])))
...
var $author$project$Generate$main = A2($author$project$Gen$CodeGen$Generate$fromJson, $author$project$Theme$Decoder$decode, $author$project$Theme$Generate$generate);
