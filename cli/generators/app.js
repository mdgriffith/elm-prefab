...
var $author$project$Gen$Browser$call_ = {
	application: function (applicationArg) {
		return A2(
...
var $author$project$Gen$App$Effect$call_ = {
	...
	replaceUrl: function (replaceUrlArg) {
		return A2(
			$mdgriffith$elm_codegen$Elm$apply,
			$mdgriffith$elm_codegen$Elm$value(
				{
						...
						annotation: $elm$core$Maybe$Just(
							A2(
								...
								_List_fromArray(
									[
										A2(
										$mdgriffith$elm_codegen$Elm$Annotation$extensible,
										'options',
										_List_fromArray(
											[
												_Utils_Tuple2(
...
var $author$project$Gen$App$State$initLimit = $mdgriffith$elm_codegen$Elm$value(
	{
		annotation: $elm$core$Maybe$Just(
			A3($mdgriffith$elm_codegen$Elm$Annotation$namedWith, _List_Nil, 'Limit', _List_Nil)),
		importFrom: _List_fromArray(
			['App', 'State']),
		name: 'initLimit'
	});
...
var $mdgriffith$elm_codegen$Elm$Let$tuple = F4(
	function (desiredNameOne, desiredNameTwo, valueExpr, sourceLet) {
		return A2(
			$mdgriffith$elm_codegen$Elm$Let$with,
			$mdgriffith$elm_codegen$Elm$Let$Let(
				function (index) {
					var _v0 = A2($mdgriffith$elm_codegen$Internal$Index$getName, desiredNameOne, index);
					var oneName = _v0.a;
					var oneIndex = _v0.b;
					var _v1 = A2($mdgriffith$elm_codegen$Internal$Index$getName, desiredNameTwo, oneIndex);
					var twoName = _v1.a;
					var twoIndex = _v1.b;
					var _v2 = A2($mdgriffith$elm_codegen$Internal$Compiler$toExpressionDetails, twoIndex, valueExpr);
					var newIndex = _v2.a;
						...
						letDecls: _List_fromArray(
							[
								...
								A2(
									...
									$mdgriffith$elm_codegen$Internal$Compiler$nodify(sourceDetails.expression)))
							]),
						_return: _Utils_Tuple2(
							$mdgriffith$elm_codegen$Internal$Compiler$Expression(
								function (_v3) {
									return {
										annotation: function () {
											var _v4 = sourceDetails.annotation;
											if (_v4.$ === 'Err') {
												var e = _v4.a;
												return $elm$core$Result$Err(e);
											} else {
												var inference = _v4.a;
												var _v5 = inference.type_;
												if ((((_v5.$ === 'Tupled') && _v5.a.b) && _v5.a.b.b) && (!_v5.a.b.b.b)) {
													var _v6 = _v5.a;
													var _v7 = _v6.a;
													var oneType = _v7.b;
													var _v8 = _v6.b;
													...
													var twoType = _v9.b;
													return $elm$core$Result$Ok(
														{aliases: inference.aliases, inferences: $elm$core$Dict$empty, type_: oneType});
												} else {
													return $elm$core$Result$Err(_List_Nil);
												}
											}
										}(),
										expression: A2($stil4m$elm_syntax$Elm$Syntax$Expression$FunctionOrValue, _List_Nil, oneName),
							...
							$mdgriffith$elm_codegen$Internal$Compiler$Expression(
								function (_v10) {
									return {
										annotation: function () {
											var _v11 = sourceDetails.annotation;
											if (_v11.$ === 'Err') {
												var e = _v11.a;
												return $elm$core$Result$Err(e);
											} else {
												var inference = _v11.a;
												var _v12 = inference.type_;
												if ((((_v12.$ === 'Tupled') && _v12.a.b) && _v12.a.b.b) && (!_v12.a.b.b.b)) {
													var _v13 = _v12.a;
													var _v14 = _v13.a;
													var oneType = _v14.b;
													var _v15 = _v13.b;
													...
													var twoType = _v16.b;
													return $elm$core$Result$Ok(
														{aliases: inference.aliases, inferences: $elm$core$Dict$empty, type_: twoType});
												} else {
													return $elm$core$Result$Err(_List_Nil);
												}
											}
										...
										expression: A2(
											$stil4m$elm_syntax$Elm$Syntax$Expression$FunctionOrValue,
											_List_Nil,
											$mdgriffith$elm_codegen$Internal$Format$sanitize(twoName)),
										imports: _List_Nil
									};
								}))
					};
			...
			A4(
				...
				$mdgriffith$elm_codegen$Elm$Let$letIn(
					function (_v0) {
							...
							$mdgriffith$elm_codegen$Elm$record(
								_List_fromArray(
									[
										...
										_Utils_Tuple2('views', $author$project$Press$Generate$Regions$values.empty),
						...
						return A2($mdgriffith$elm_codegen$Elm$tuple, model, globalFrameEffect);
					})));
	});
var $author$project$Press$Model$toCmd = F4(
	function (config, navKey, frameModel, effect) {
		return A2(
			$mdgriffith$elm_codegen$Elm$apply,
		...
		return A2(
			...
			A2(
				...
				A2(
					...
					_Utils_Tuple2(
						'config',
						$elm$core$Maybe$Just($author$project$Press$Model$types.frame)),
					function (config) {
						return A2(
							$mdgriffith$elm_codegen$Elm$withType,
							A3(
									...
									_List_fromArray(
										[
											...
											A4(
												...
												_Utils_Tuple2(
													'flags',
													$elm$core$Maybe$Just($author$project$Gen$Json$Encode$annotation_.value)),
												_Utils_Tuple2(
													'url',
													$elm$core$Maybe$Just($author$project$Gen$Url$annotation_.url)),
												_Utils_Tuple2(
													'key',
													$elm$core$Maybe$Just($author$project$Gen$Browser$Navigation$annotation_.key)),
												F3(
																	...
																	function (_v0) {
																		...
																		return A2(
																			...
																			A4(
																				...
																				A2($mdgriffith$elm_codegen$Elm$get, 'frame', newModel),
																				effect));
																	})));
													}))),
											_Utils_Tuple2(
											...
											A3(
												...
												_Utils_Tuple2(
													'msg',
													$elm$core$Maybe$Just($author$project$Press$Model$types.msg)),
												_Utils_Tuple2(
													'model',
											...
											A2(
												...
												_Utils_Tuple2(
													'urlRequest',
													$elm$core$Maybe$Just($author$project$Gen$Browser$annotation_.urlRequest)),
												function (urlRequest) {
													return A2(
														$mdgriffith$elm_codegen$Elm$apply,
														$mdgriffith$elm_codegen$Elm$val('Global'),
...
var $mdgriffith$elm_codegen$Elm$Declare$fn3 = F5(
	function (name, one, two, three, toExp) {
		var funcExp = A4($mdgriffith$elm_codegen$Elm$fn3, one, two, three, toExp);
		...
		var call = F4(
			function (importFrom, argOne, argTwo, argThree) {
				return A2(
					$mdgriffith$elm_codegen$Elm$apply,
...
var $author$project$Gen$App$State$call_ = {
	addToLimit: F2(
		function (addToLimitArg, addToLimitArg0) {
			return A2(
				$mdgriffith$elm_codegen$Elm$apply,
				$mdgriffith$elm_codegen$Elm$value(
					{
	...
	insert: F3(
		function (insertArg, insertArg0, insertArg1) {
			return A2(
				$mdgriffith$elm_codegen$Elm$apply,
				$mdgriffith$elm_codegen$Elm$value(
					{
	...
	removeFromLimit: F2(
		function (removeFromLimitArg, removeFromLimitArg0) {
			return A2(
				$mdgriffith$elm_codegen$Elm$apply,
				$mdgriffith$elm_codegen$Elm$value(
					{
				...
				_List_fromArray(
					[removeFromLimitArg, removeFromLimitArg0]));
		}),
	values: function (valuesArg) {
		return A2(
			$mdgriffith$elm_codegen$Elm$apply,
			$mdgriffith$elm_codegen$Elm$value(
				{
...
var $mdgriffith$elm_codegen$Elm$Case$otherwise = function (toExp) {
	return $mdgriffith$elm_codegen$Internal$Branch$Branch(
		function (index) {
			...
			return _Utils_Tuple3(
				other.index,
				$stil4m$elm_syntax$Elm$Syntax$Pattern$VarPattern(other.name),
				toExp(other.val));
		});
};
						...
						return A3(
							...
							_List_fromArray(
								[
									...
									pageConstructor,
									_Utils_Tuple2('page', $author$project$Press$Model$types.pageModel),
									onFound.just),
...
var $author$project$Press$Model$getPageInit = function (pages) {
	return A5(
		...
		_Utils_Tuple2(
			'shared',
			$elm$core$Maybe$Just($author$project$Press$Model$sharedType)),
		_Utils_Tuple2(
			'cache',
			$elm$core$Maybe$Just(
...
var $mdgriffith$elm_codegen$Elm$Declare$fn4 = F6(
	function (name, one, two, three, four, toExp) {
		var funcExp = A5($mdgriffith$elm_codegen$Elm$fn4, one, two, three, four, toExp);
		var valueFrom = function (importFrom) {
			return $mdgriffith$elm_codegen$Internal$Compiler$Expression(
				function (index) {
					var toFnExp = funcExp.a;
		...
		var call = F5(
			function (importFrom, argOne, argTwo, argThree, argFour) {
				return A2(
					$mdgriffith$elm_codegen$Elm$apply,
					valueFrom(importFrom),
					_List_fromArray(
							...
							A2(
								...
								A2(
									...
									A2(
										...
										_List_fromArray(
											[
												A2($mdgriffith$elm_codegen$Elm$get, 'views', model)
											])))),
							A3(
								$mdgriffith$elm_codegen$Elm$Let$value,
								'pageGroupKey',
...
var $author$project$Gen$App$Sub$call_ = {
	...
	toSubscription: F2(
		function (toSubscriptionArg, toSubscriptionArg0) {
			return A2(
				$mdgriffith$elm_codegen$Elm$apply,
				$mdgriffith$elm_codegen$Elm$value(
					{
				...
				_List_fromArray(
					[toSubscriptionArg, toSubscriptionArg0]));
		})
};
...
var $author$project$Press$Model$toShared = F2(
	function (config, frameModel) {
		return A2(
			$mdgriffith$elm_codegen$Elm$apply,
			A2($mdgriffith$elm_codegen$Elm$get, 'toShared', config),
			_List_fromArray(
				[frameModel]));
	});
var $author$project$Press$Model$toSub = F3(
	function (config, frameModel, sub) {
		return A2(
			$mdgriffith$elm_codegen$Elm$apply,
	...
	return A2(
		...
		A2(
			...
			A3(
				...
				_Utils_Tuple2(
					'config',
					$elm$core$Maybe$Just($author$project$Press$Model$types.frameSub)),
				_Utils_Tuple2(
					'model',
					$elm$core$Maybe$Just($author$project$Press$Model$types.model)),
				F2(
						...
						return $author$project$Gen$Platform$Sub$batch(
							_List_fromArray(
								[
									...
									$author$project$Gen$Platform$Sub$call_.batch(
									A2(
...
var $author$project$Press$Generate$Engine$test = F2(
	function (getPageInit, loadPage) {
		return A2(
			...
			{
				exposeConstructor: true,
				group: $elm$core$Maybe$Just('Testing')
			},
			A2(
				$mdgriffith$elm_codegen$Elm$declaration,
				'test',
				A2(
					...
					_Utils_Tuple2(
						'config',
						$elm$core$Maybe$Just($author$project$Press$Model$types.frameTest)),
					function (config) {
						return A2(
							$mdgriffith$elm_codegen$Elm$withType,
							A3(
...
var $author$project$Press$Generate$Engine$testAlias = A2(
	$mdgriffith$elm_codegen$Elm$exposeWith,
	{
		exposeConstructor: true,
		group: $elm$core$Maybe$Just('Testing')
							...
							if (pageInfo.elmModuleIsPresent) {
								...
								return toBranch(
									function (_v0) {
										return A2(
											$mdgriffith$elm_codegen$Elm$Op$pipe,
											$mdgriffith$elm_codegen$Elm$val('.pageCacheLimit'),
											A2(
												$mdgriffith$elm_codegen$Elm$apply,
												$author$project$Gen$App$Engine$Page$values_.toInternalDetails,
												_List_fromArray(
								...
								_Utils_ap(
									_List_fromArray(
										[
											...
											$mdgriffith$elm_codegen$Elm$Case$branch1,
											'ViewUpdated',
											_Utils_Tuple2('operation', $author$project$Press$Model$types.regionOperation),
...
var $author$project$Press$Generate$Engine$view = function (routes) {
	return A2(
		...
		A3(
			...
			_Utils_Tuple2(
				'config',
				$elm$core$Maybe$Just($author$project$Press$Model$types.frameView)),
			_Utils_Tuple2(
				'model',
				$elm$core$Maybe$Just($author$project$Press$Model$types.model)),
			F2(
...
var $author$project$Press$Generate$Engine$viewPageModel = function (pages) {
	return A2(
		...
		A5(
			...
			_Utils_Tuple2(
				'shared',
				$elm$core$Maybe$Just($author$project$Press$Model$types.sharedType)),
			_Utils_Tuple2(
				'states',
				$elm$core$Maybe$Just($author$project$Press$Model$types.stateCache)),
			_Utils_Tuple2(
				'regionId',
...
var $author$project$Press$Generate$Engine$viewType = A2(
	$mdgriffith$elm_codegen$Elm$exposeWith,
	{
		exposeConstructor: true,
		group: $elm$core$Maybe$Just('App')
...
var $author$project$Generate$main = $author$project$Gen$CodeGen$Generate$withFeedback(
	function (flags) {
		var _v0 = A2(
			...
			A2($elm$json$Json$Decode$field, 'pageUsages', $author$project$Press$Model$decodePageUsages),
			flags);
		if (_v0.$ === 'Ok') {
			var pageUsages = _v0.a;
