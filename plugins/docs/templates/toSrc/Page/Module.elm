...
page : App.Page.Page App.Shared.Shared App.Page.Id.Module_Params Msg Model
page =
    App.Page.page
        { init = init
        , update = update
...
init : App.Page.Id.Module_Params -> App.Shared.Shared -> Maybe Model -> App.Page.Init Msg Model
